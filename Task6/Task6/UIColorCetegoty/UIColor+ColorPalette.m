...
+ (UIColor *) customBlack {
    return [UIColor convertColorWithHex: 0x101010];
}

+ (UIColor *) customWhite {
    return [UIColor convertColorWithHex: 0xFFFFFF];
}

+ (UIColor *) customRed {
    return [UIColor convertColorWithHex: 0xEE686A];
}

+ (UIColor *) customBlue {
    return [UIColor convertColorWithHex: 0x29C2D1];
}

+ (UIColor *) customYellow {
    return [UIColor convertColorWithHex: 0xF9CC78];
}

+ (UIColor *) customYellowHighlighted {
    return [UIColor convertColorWithHex: 0xFDF4E3];
}

+ (UIColor *) customGray {
    return [UIColor convertColorWithHex: 0x707070];
}
